...
export default function Benefits() {
  return (
    <section id="beneficios" className="relative py-24 overflow-hidden">
      <div className="absolute left-0 right-0 top-1/2 -translate-y-1/2 h-96 bg-[radial-gradient(ellipse_80%_50%_at_50%_50%,rgba(245,126,29,0.06)_0%,transparent_70%)] pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="aos grid md:grid-cols-2 gap-4 mb-14 rounded-2xl overflow-hidden border border-[rgba(245,126,29,0.12)]">
          ...
          <div className="p-6 bg-[rgba(245,126,29,0.05)]">
