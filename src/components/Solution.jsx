...
export default function Solution() {
  return (
    <section id="solucion" className="relative py-24 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-[#050812] via-[#0d1c35]/30 to-[#050812] pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-5 gap-8 items-center mb-16">
          ...
          <div className="lg:col-span-3 aos">
            <div className="relative rounded-2xl overflow-hidden border border-[rgba(245,126,29,0.2)]" style={{ boxShadow: '0 30px 70px rgba(0,0,0,0.5), 0 0 40px rgba(245,126,29,0.08)' }}>
              <img
              ...
              {/* Live indicator */}
              <div className="absolute top-4 right-4 flex items-center gap-2 bg-[#0a1420]/90 backdrop-blur-sm rounded-full px-3 py-1.5 border border-[rgba(245,126,29,0.2)]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5 grid grid-cols-3 gap-3">
                {[
                  ...
                  <div key={s.label} className="bg-[#0a1420]/80 backdrop-blur-sm rounded-xl p-3 border border-[rgba(245,126,29,0.15)] text-center">
          ...
          <div className="lg:col-span-2 space-y-4">
            {PILLARS.map((p, i) => (
              <div
                key={p.title}
                className="aos card-hover flex items-start gap-4 p-4 rounded-xl bg-[rgba(245,126,29,0.05)] border border-[rgba(245,126,29,0.12)]"
