...
export default function Contact() {
  ...
  return (
    <section id="contacto" className="relative py-24 overflow-hidden">
      {/* Background glow */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_100%,rgba(245,126,29,0.12)_0%,transparent_70%)] pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="aos rounded-3xl bg-gradient-to-r from-[#0d1c35] via-[#0f2847] to-[#0d1c35] border border-[rgba(245,126,29,0.2)] p-10 md:p-14 text-center mb-16" style={{ boxShadow: '0 0 80px rgba(245,126,29,0.08)' }}>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              ...
              className="flex items-center gap-2 px-7 py-3.5 rounded-xl bg-[var(--brand)] text-[#050812] font-semibold hover:bg-[#00c8bb] transition-colors glow-brand"
            >
              <Mail size={18} />
              Enviar correo
            </a>
            <a
              href="#form"
              className="flex items-center gap-2 px-7 py-3.5 rounded-xl border border-[rgba(245,126,29,0.3)] text-white font-semibold hover:bg-[rgba(245,126,29,0.08)] transition-colors"
            >
              Solicitar demo
              <ArrowRight size={16} />
            </a>
        ...
        <div className="grid lg:grid-cols-2 gap-12" id="form">
          ...
          <div className="aos">
            ...
            {sent ? (
              <div className="rounded-2xl bg-[rgba(245,126,29,0.08)] border border-[rgba(245,126,29,0.2)] p-8 text-center">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[rgba(245,126,29,0.05)] border border-[rgba(245,126,29,0.15)] rounded-xl px-4 py-3 text-white placeholder-white/25 text-sm focus:outline-none focus:border-[var(--brand)] transition-colors"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-[rgba(245,126,29,0.05)] border border-[rgba(245,126,29,0.15)] rounded-xl px-4 py-3 text-white placeholder-white/25 text-sm focus:outline-none focus:border-[var(--brand)] transition-colors resize-none"
                  />
                </div>
                <button
                  type="submit"
                  className="w-full py-3.5 rounded-xl bg-[var(--brand)] text-[#050812] font-semibold hover:bg-[#00c8bb] transition-colors glow-brand"
                >
                  Enviar mensaje →
                </button>
              </form>
          ...
          <div className="aos space-y-6">
            ...
            <div className="space-y-4">
              {[
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-4 p-4 rounded-xl bg-[rgba(245,126,29,0.05)] border border-[rgba(245,126,29,0.1)] hover:border-[rgba(245,126,29,0.3)] transition-all group"
                >
            ...
            {/* Map placeholder */}
            <div className="rounded-2xl overflow-hidden border border-[rgba(245,126,29,0.15)] h-40 relative">
              <img
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="bg-[#0a1420]/90 backdrop-blur-sm rounded-xl px-4 py-2 border border-[rgba(245,126,29,0.2)]">
