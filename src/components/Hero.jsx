    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: '0 0 10px rgba(245,126,29,0.6)',
        }}
      />
    </div>
  )
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 80% 50% at 50% -5%, rgba(245,126,29,0.22) 0%, transparent 70%)',
        }}
      />
      ...
      <div className="relative max-w-7xl mx-auto px-6 z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            {/* Badge */}
            <div className="hero-anim inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[rgba(245,126,29,0.3)] bg-[rgba(245,126,29,0.08)] text-[var(--brand)] text-sm font-medium mb-6">
            ...
            <div className="hero-anim flex flex-wrap gap-3 mb-10">
              {[
                ...
                <span
                  key={b.label}
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[rgba(245,126,29,0.1)] border border-[rgba(245,126,29,0.2)] text-sm text-white/70"
                >
            ...
            <div className="hero-anim flex flex-wrap gap-4">
              <a
                href="#contacto"
                className="flex items-center gap-2 px-6 py-3 rounded-xl bg-[var(--brand)] text-[#050812] font-semibold text-base hover:bg-[#00c8bb] transition-all duration-200 glow-brand"
              >
                Solicitar demo
                <ArrowRight size={16} />
              </a>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 px-6 py-3 rounded-xl border border-[rgba(245,126,29,0.3)] text-white font-semibold text-base hover:bg-[rgba(245,126,29,0.08)] transition-all duration-200"
              >
          ...
          <div className="relative hidden lg:block">
            ...
            <div className="floating relative">
              <div className="relative rounded-2xl overflow-hidden border border-[rgba(245,126,29,0.2)] shadow-2xl" style={{ boxShadow: '0 40px 80px rgba(0,0,0,0.6), 0 0 60px rgba(245,126,29,0.1)' }}>
                <img
                ...
                />
                {/* overlay */}
                <div className="absolute inset-0 bg-gradient-to-t from-[#050812]/80 via-transparent to-transparent" />
                {/* Stat chip on image */}
                <div className="absolute bottom-4 left-4 right-4 flex gap-3">
                  <div className="flex-1 bg-[#0a1420]/90 backdrop-blur-sm rounded-xl p-3 border border-[rgba(245,126,29,0.2)]">
              ...
              {/* Floating GPS card */}
              <div className="absolute -top-6 -right-6 bg-[#0a1420] border border-[rgba(245,126,29,0.3)] rounded-xl p-3 shadow-xl w-44">
              ...
              {/* Floating photo card */}
              <div className="absolute -bottom-6 -left-6 bg-[#0a1420] border border-[rgba(245,126,29,0.3)] rounded-xl p-3 shadow-xl w-40">
                <div className="flex items-center gap-2 mb-2">
      ...
      {/* Bottom fade */}
      <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-[#050812] to-transparent pointer-events-none" />
    </section>
  )
}
